...
RIM_SEARCH_RADIUS_KM = 20  # roughly one crater-radius, since these craters are 20-40km wide
...
for name, (lat, lon, is_rim) in sites.items():
    ...
    if is_rim:
        # Search a small window around the center and take the brightest
        # cell nearby, since "rim" sites are the sunlit crest, not the center.
...
print("\nSaved data/sunlight_ice_dust_final.json (overwritten with corrected rim sampling)")
